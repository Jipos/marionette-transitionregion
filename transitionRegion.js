...
(function(root, factory) {
  ...
  if (typeof define === 'function' && define.amd) {
    return define(['backbone.marionette'], function(marionette) {
      return factory(root, marionette);
    });
  } else if (typeof exports === 'object') {
    Marionette = require('backbone.marionette');
    return module.exports = factory(root, Marionette);
  } else {
    return factory(root, Backbone.Marionette);
  }
})(this, function(Marionette) {
  var FadeTransitionRegion, getFadeDuration;
